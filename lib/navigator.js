...
;(function(run) {
  ...
  var nav = exports.navigator = {
    ...
    backwardUpSexp: function(ast, idx) {
      var containing = w.sexpsAt(ast, idx, function(n) {
        return n.type === 'list' && n.start !== idx && n.end !== idx; });
  ...
  var w = exports.walk = {
    ...
    nextSexp: function(ast, idx, matchFunc) {
      ...
      var direct = listsAt.filter(function(n) {
        return n.start === idx && (!matchFunc || matchFunc(n)); })[0];
    ...
    prevSexp: function(ast,idx,matchFunc) {
      ...
      if (!listsAt.length) return null;
      var direct = listsAt.filter(function(n) {
        return n.end === idx && (!matchFunc || matchFunc(n)); })[0];
      if (direct) return direct;
