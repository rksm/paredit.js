    ...
    splitSexp: function(ast, idx) {
      ...
      var childrenGrouped = lively.lang.arr.groupBy(sexp.children,
          ...
          right = lively.lang.obj.merge(sexp, {
            children: (childrenGrouped.right || []).map(moveNode.bind(null,insertion.length)),
            start: idx+(insertion.length-open.length),
            end: sexp.end+insertion.length
          });
      ...
      return {ast: newAST.nodes[0], changes: changes, newIndex: newIndex};
    }
  };
